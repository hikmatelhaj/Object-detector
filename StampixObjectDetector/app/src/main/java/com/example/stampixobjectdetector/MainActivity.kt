...
class MainActivity : AppCompatActivity() {
    ...
    private val UPDATE_INTERVAL_MS = 500 // 1 second
//
        ...
        textureView.surfaceTextureListener = object:TextureView.SurfaceTextureListener {
            ...
            override fun onSurfaceTextureUpdated(surface: SurfaceTexture) {
                ...
                if (currentTime - lastUpdateTime >= UPDATE_INTERVAL_MS) {
                    // To not reset the hashmap constantly, to easier detect clicks
                ...
                scores.forEachIndexed{ index, fl ->
                    ...
                    if (fl > 0.6) {
                        ...
                        val rectangle = RectF(locations[x+1] * w, locations[x] * h, locations[x+3] *w, locations[x+2] *h)
                        canvas.drawRect(rectangle, paint)
                        paint.style = Paint.Style.FILL
                        val label = labels[classes[index].toInt()] + " " + fl.toString()
                        val xLabel = locations[x+1] *w
                        val yLabel = locations[x] *h
